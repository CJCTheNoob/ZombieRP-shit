...
TEAM_CITIZEN = AddExtraTeam("Scavenger", {
	color = Color(20, 150, 20, 255),
	model = {
		"models/player/Group01/Female_01.mdl",
		"models/player/Group01/Female_02.mdl",
	...
	description = [[You are a Scavenger, a man that his
		only objective is to walk around in the
		Wasteland, you can't have a house, but a tent
		to take shelter during the night and storms.]],
	weapons = {},
	command = "Scavenger",
	max = 0,
	salary = 15,
...
TEAM_NINJA = AddExtraTeam("Ninja", {
	...
	description = [[Youre a ninja, The most skilled person
		in the wasteland, you raid to survive.]],
	weapons = {"weapon_crossbow", "fas2_dv2", "climb_swep2"},
	command = "admin",
	max = 5,
	salary = 15,
	admin = 1,
